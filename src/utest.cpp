...
UTest::UTest(): _num_tests(0), _num_failed_tests(0), _num_successful_tests(0){}
UTest::UTest(std::string name): _num_tests(0), _num_failed_tests(0), _num_successful_tests(0), _suit_name(name){}

void UTest::test(std::string test_name, bool flag){
